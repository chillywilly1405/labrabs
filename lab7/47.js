/** ЗАДАЧА 47 - Деструктуризация массива
 *
 ...
 */
 ...
 const processQuantities = ([minQty, maxQty, defaultQty] = inp) => {
  console.log(minQty) // 8
  console.log(maxQty) // 29
  console.log(defaultQty) // 10 в первом вызове, 0 во втором
